    ...
    <nav>
      ...
      <button className={s.menuIcon} onClick={() => toggle(navState)}>
        <div className={s.container}>
          <div
            className={`${s.stick} ${s.stick1} ${navState ? s.open : s.close}`}
          />
          <div
            className={`${s.stick} ${s.stick2} ${navState ? s.open : s.close}`}
          />
          <div
            className={`${s.stick} ${s.stick3} ${navState ? s.open : s.close}`}
          />
        </div>
      </button>
