    ...
    <div className={`${s.inner} ${s.split}`}>
      <section>
        ...
        <ul className={s.actions}>
          <li><a href="#" className={`${s.button} ${s.alt}`}>Learn more</a></li>
        </ul>
      </section>
      <section>
        <ul className={s.checklist}>
          <li><i className={`fas fa-check ${s.faStyle}`} />Ipsum nisl sed cursus magna</li>
          <li><i className={`fas fa-check ${s.faStyle}`} />Amet veroeros sed aliquam consequat</li>
          <li><i className={`fas fa-check ${s.faStyle}`} />Tempus lorem adipiscing et lorem</li>
          <li><i className={`fas fa-check ${s.faStyle}`} />Morbi pharetra vitae felis placerat</li>
          <li><i className={`fas fa-check ${s.faStyle}`} />Pharetra nulla risus orci dapibus</li>
        </ul>
      </section>
    </div>
  </section>
